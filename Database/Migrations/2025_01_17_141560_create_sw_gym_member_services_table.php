...
class CreateSwGymMemberServicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sw_gym_member_services', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sw_gym_member_services');
    }
}
