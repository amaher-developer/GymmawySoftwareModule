@php
    ...
    $showSettingsMenu = $isSuperUser
        ...
        || isset($permissionsMap['listPaymentType']) || isset($permissionsMap['createPaymentType']) || isset($permissionsMap['editPaymentType']) || isset($permissionsMap['deletePaymentType'])
        || isset($permissionsMap['listMoneyBoxType']) || isset($permissionsMap['createMoneyBoxType']) || isset($permissionsMap['editMoneyBoxType']) || isset($permissionsMap['deleteMoneyBoxType'])
...
@if ($swUser && $showSettingsMenu)
 ...
 {{-- Activities (moved under Settings) --}}
            ...
            @if ($swUser && (isset($permissionsMap['listPaymentType']) || isset($permissionsMap['createPaymentType']) || isset($permissionsMap['editPaymentType']) || isset($permissionsMap['deletePaymentType']) || $isSuperUser))
                <!--begin:Menu item-->
                <div class="menu-item">
                    <!--begin:Menu link-->
            ...
            @if ($swUser && (isset($permissionsMap['listMoneyBoxType']) || isset($permissionsMap['createMoneyBoxType']) || isset($permissionsMap['editMoneyBoxType']) || isset($permissionsMap['deleteMoneyBoxType']) || $isSuperUser))
                <!--begin:Menu item-->
                <div class="menu-item">
                    <!--begin:Menu link-->
