    ...
    <div class="main">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="#">{{trans('sw.user_profile')}}</a></li>
            </ul>
                    ...
                    <div class="content-page">
                        <div class="row margin-bottom-30">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <div class="content-page">
                                    @if(@$mainSettings->cover_images)
                                    <!-- BEGIN CAROUSEL -->
                                    <div class="front-carousel margin-bottom-20">
                                        <div id="myCarousel" class="carousel slide">
                                            <!-- Carousel items -->
                                            <div class="carousel-inner">
                                                @foreach(@$mainSettings->cover_images as $image)
                                    ...
                                    @endif
                                    <!-- BEGIN INFO BLOCK -->
                                    <h2>{{trans('sw.membership_info')}}</h2>
                                    <p><br/></p>
                                    <!-- BEGIN LISTS -->
                                    <div class="row front-lists-v1">
                                        <div class="col-md-6">
                                            <ul class="list-unstyled margin-bottom-20">
                                                <li><i class="fa fa-user"></i> <b>{{trans('sw.name')}}:</b> {{$member->name}}</li>
                                                <li><i class="fa fa-calendar"></i> <b>{{trans('sw.joining_date')}}:</b> {{\Carbon\Carbon::parse(@$member->member_subscription_info->joining_date)->toDateString()}} </li>
                                                <li><i class="fa fa-dollar"></i> <b>{{trans('sw.amount_paid')}}:</b> {{@$member->member_subscription_info->amount_paid}}</li>
                                                <li><i class="fa fa-check"></i> <b>{{trans('sw.membership')}}:</b> {{@$member->member_subscription_info->subscription->name}}</li>
                                            </ul>
                                        </div>
                                        <div class="col-md-6">
                                            <ul class="list-unstyled">
                                                <li><i class="fa fa-phone"></i> <b>{{trans('sw.phone')}}:</b> {{$member->phone}}</li>
                                                <li><i class="fa fa-calendar"></i> <b>{{trans('sw.expire_date')}}:</b> {{\Carbon\Carbon::parse(@$member->member_subscription_info->expire_date)->toDateString()}} </li>
                                                <li><i class="fa fa-dollar"></i> <b>{{trans('sw.amount_remaining')}}:</b> {{@$member->member_subscription_info->amount_remaining}}</li>
                                                <li><i class="fa fa-check"></i> <b>{{trans('sw.status')}}:</b> {{@$member->member_subscription_info->status_name}}</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!-- END LISTS -->
