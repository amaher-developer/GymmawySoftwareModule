    ...
    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-title">
            <div class="d-flex align-items-center my-1">
                ...
                <span class="fs-4 fw-semibold text-gray-900">{{ trans('sw.logs')}}</span>
            </div>
        </div>
        <!--end::Card title-->
    </div>
                            ...
                            <td class="pe-0">
                                <div class="d-flex flex-column">
                                    <div class="text-muted fw-bold d-flex align-items-center">
                                        ...
                                        <span>{{ $log->created_at ? $log->created_at->format('Y-m-d') : '-' }}</span>
                                    </div>
                                    <div class="text-muted fs-7 d-flex align-items-center">
                                        <i class="ki-outline ki-time fs-6 text-muted me-2"></i>
                                        <span>{{ $log->created_at ? $log->created_at->format('h:i a') : '-' }}</span>
                                    </div>
                                </div>
                            </td>
                            <td class="pe-0">
