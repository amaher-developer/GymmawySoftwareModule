            ...
            <div class="mw-lg-950px mx-auto w-100">
                ...
                <div class="pb-12">
                    ...
                    <div class="d-flex flex-column gap-7 gap-md-10">
                        ...
                        {{-- Linked Invoice --}}
                        @if($order->invoice)
                        <div class="d-flex flex-column gap-3 hidden-print">
                            <div class="separator"></div>
                            <div class="d-flex align-items-center gap-3">
                                <span class="text-muted">{{ trans('sw.invoice_number') }}: </span>
                                <span class="fw-bold">{{ $order->invoice->invoice_number }}</span>
                                <a href="{{ route('sw.gymSwInvoices.show', $order->invoice->id) }}" class="btn btn-sm btn-light-primary">
