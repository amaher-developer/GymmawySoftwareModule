...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .activity-list li { padding: 4px 0; border-bottom: 1px dotted #eee; font-size: 13px; }
...
<body>
    ...
    <div class="invoice-card">
        <div class="invoice-card-header">
            <span>{{ trans('sw.activity') ?? trans('front.activity') ?? 'Activity' }}</span>
                ...
                <ul class="activity-list" style="width:100%">
                    @foreach($storedActivities as $act)
                        ...
                        <li>
                            {{ $actName }}
                            @if($actTotal > 0)
                                — {{ number_format($actTotal, 2) }} {{ trans('front.pound_unit') }}
                            @endif
                        </li>
                    @endforeach
                </ul>
