                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                @if($member->type == \Modules\Software\Classes\TypeConstants::DIET_PLAN_TYPE)
                                            <img alt="{{$member->type_name}}" title="{{$member->type_name}}" class="symbol-label rounded-circle" src="{{asset('resources/assets/new_front/images/diet_training.png')}}">
                                        @else
                                            <img alt="{{$member->type_name}}" title="{{$member->type_name}}" class="symbol-label rounded-circle" src="{{asset('resources/assets/new_front/images/bar_training.png')}}">
                                        @endif
                                </div>
                                <div class="d-flex flex-column">
