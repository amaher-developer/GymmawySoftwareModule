    ...
    <div class="card-body pt-0">
        ...
        @if(count($logs) > 0)
            ...
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_wa_logs_table">
                <thead>
                            ...
                            <td class="pe-0 text-center">
                                @if($log->status)
                                    <span class="badge badge-light-success fs-7">
                                        <i class="ki-outline ki-check-circle fs-6 me-1"></i>{{ trans('sw.success')}}
                                    </span>
                                @else
                                    <span class="badge badge-light-danger fs-7">
                                        <i class="ki-outline ki-cross-circle fs-6 me-1"></i>{{ trans('sw.failed')}}
                                    </span>
                                @endif
                            </td>
                            <td class="pe-0">
