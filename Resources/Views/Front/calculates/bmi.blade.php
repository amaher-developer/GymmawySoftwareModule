    ...
    <div class="row">
        ...
        <div class="col-md-9">
                ...
                <div class="box_detail booking" style="background-color: white">
                    ...
                    <!--begin::BMI Calculation Form-->
                    <form id="submit_calculate_bmi_form" class="form d-flex flex-column flex-lg-row" autocomplete="off">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="number" value="60" name="bmi_weight" id="bmi_weight" placeholder="" class="form-control mb-2" required>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="number" value="180" name="bmi_height" id="bmi_height" class="form-control mb-2" required>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="submit" class="btn btn-primary" id="submit_calculate_bmi">
...
@section('scripts')
    <script>
        $("#submit_calculate_bmi_form").submit(function(){
                bmi_height = $('#bmi_height').val();
                bmi_weight = $('#bmi_weight').val();
                $.ajax({
                    url: "{{route('sw.calculateBMIResult')}}",
                    type: 'POST',
                    data: {
