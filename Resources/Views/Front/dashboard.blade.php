...
@section('page_body')
    ...
    <div class="row g-5">
                    ...
                    <div class="row g-1">
                        @if($swUser && @$mainSettings->active_subscription && (in_array('listSubscription', (array)($swUser->permissions ?? [])) || $swUser->is_super_user))
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.listSubscription')}}" class="btn btn-light-primary btn-sm w-100 p-2">
                        ...
                        @if($swUser && (@$mainSettings->active_activity || @$mainSettings->active_activity_reservation) && (in_array('listActivity', (array)($swUser->permissions ?? [])) || $swUser->is_super_user))
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.listActivity')}}" class="btn btn-light-info btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
                        ...
                        @if($swUser && @$mainSettings->active_subscription && (in_array('listMember', (array)($swUser->permissions ?? [])) || $swUser->is_super_user))
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.listMember')}}" class="btn btn-light-danger btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
                        ...
                        @if($swUser && @$mainSettings->active_subscription && (in_array('createMember', (array)($swUser->permissions ?? [])) || $swUser->is_super_user))
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.createMember')}}" class="btn btn-light-success btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
                        ...
                        @if($swUser && (@$mainSettings->active_activity || @$mainSettings->active_activity_reservation) && (in_array('listNonMember', (array)($swUser->permissions ?? [])) || $swUser->is_super_user))
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.listNonMember')}}" class="btn btn-light-warning btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
                        ...
                        @if($swUser && (@$mainSettings->active_activity || @$mainSettings->active_activity_reservation) && (in_array('createNonMember', (array)($swUser->permissions ?? [])) || $swUser->is_super_user))
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.createNonMember')}}" class="btn btn-light-secondary btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
                        ...
                        @if($swUser && (in_array('listPotentialMember', (array)($swUser->permissions ?? [])) || $swUser->is_super_user))
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.listPotentialMember')}}" class="btn btn-light-primary btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
                        ...
                        @if($swUser && (in_array('createStoreOrderPOS', (array)($swUser->permissions ?? [])) || $swUser->is_super_user) && $mainSettings->active_store)
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.createStoreOrderPOS')}}" class="btn btn-light-dark btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
                        ...
                        @if($swUser && (in_array('listReports', (array)($swUser->permissions ?? [])) || $swUser->is_super_user))
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.listReports')}}" class="btn btn-light-info btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
                        ...
                        @if($swUser && (in_array('listMoneyBox', (array)($swUser->permissions ?? [])) || $swUser->is_super_user))
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.listMoneyBox').'?from='.date('m/d/Y').'&'.'to='.date('m/d/Y')}}" class="btn btn-light-success btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
                        ...
                        @if($swUser && (in_array('listPTMember', (array)($swUser->permissions ?? [])) || $swUser->is_super_user) && $mainSettings->active_pt)
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.listPTMember')}}" class="btn btn-light-primary btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
                        ...
                        @if($swUser && (in_array('listTrainingPlan', (array)($swUser->permissions ?? [])) || $swUser->is_super_user) && $mainSettings->active_training)
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.listTrainingMemberLog')}}" class="btn btn-light-info btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
                        ...
                        @if($swUser && (in_array('editSetting', (array)($swUser->permissions ?? [])) || $swUser->is_super_user))
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <a href="{{route('sw.editSetting')}}" class="btn btn-light-secondary btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
                                    <span class="fw-bold fs-7 text-center">{{ trans('sw.settings')}}</span>
                                </a>
                            </div>
                        @endif
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                            <a href="{{route('sw.customerLogin')}}" target="_blank" class="btn btn-light-warning btn-sm w-100 p-2" style="height: 90px; display: flex; align-items: center; justify-content: center;">
        ...
        <div class="col-lg-6">
            <div class="card card-flush h-100">
                <div class="card-header">
                    <h3 class="fw-bold mb-0">{{ trans('sw.member_login')}}</h3>
                </div>
                <div class="card-body pt-0">
                    ...
                    <div class="form-check form-check-custom form-check-solid">
                        ...
                        <label class="form-check-label" for="scan_barcode_enquiry">{{ trans('sw.enquiry_only')}}</label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card card-flush h-100">
                <div class="card-header">
                    <h3 class="fw-bold mb-0">{{ trans('sw.moneybox')}}</h3>
                </div>
                <div class="card-body pt-0">
                    <span class="fs-6 fw-semibold text-gray-900 d-block mb-2">{{ trans('sw.total_amount_in_fund')}}</span>
    ...
    <div class="row g-5 mt-5">
        <div class="col-xl-4 col-md-6">
            <div class="card card-flush h-100">
                <div class="card-body d-flex align-items-center">
                    <span class="fs-6 fw-semibold text-gray-900 me-auto">{{ trans('sw.last_enter_member')}}</span>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card card-flush h-100">
                <div class="card-body d-flex align-items-center">
                    <span class="fs-6 fw-semibold text-gray-900 me-auto">{{ trans('sw.last_created_member')}}</span>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card card-flush h-100">
                <div class="card-body d-flex align-items-center">
                    <span class="fs-6 fw-semibold text-gray-900 me-auto">{{ trans('sw.last_created_non_member')}}</span>
    ...
    <div class="row g-5 mt-5">
        <div class="col-lg-6">
            <div class="card card-flush h-100">
                <div class="card-header">
                    <h3 class="fw-bold mb-0">{{ trans('sw.subscriptions_details')}}</h3>
                </div>
                <div class="card-body pt-0">
                    <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#subscriptions_tab">{{ trans('sw.memberships')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#activities_tab">{{ trans('sw.activities')}}</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="subscriptions_tab">
                            <table class="table table-striped table-row-bordered" id="subscriptions_table">
                                <thead>
                        ...
                        <div class="tab-pane fade" id="activities_tab">
                            <table class="table table-striped table-row-bordered" id="activities_table">
                                <thead>
                                    <tr class="fw-semibold fs-6 text-gray-800">
                                        <th>{{ trans('sw.title')}}</th>
                                        <th>{{ trans('sw.price')}}</th>
        ...
        <div class="col-lg-6">
            <div class="card card-flush h-100">
                <div class="card-header">
                    <h3 class="fw-bold mb-0">{{ trans('sw.members_details')}}</h3>
                </div>
                <div class="card-body pt-0">
                    <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#attendance_tab">{{ trans('sw.last_attend_date')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#recent_tab">{{ trans('sw.recently')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#expired_tab">{{ trans('sw.expired')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#birthday_tab">{{ trans('sw.birthdays')}} <span class="badge badge-warning ms-2">{{@(int)count($birthday_members)}}</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#expiring_tab">{{ trans('sw.memberships_expiring')}}</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="attendance_tab">
                            <table class="table table-striped table-row-bordered" id="attendance_table">
                                <thead>
                                    <tr class="fw-semibold fs-6 text-gray-800">
                                        <th>{{ trans('sw.name')}}</th>
                        ...
                        <div class="tab-pane fade" id="recent_tab">
                            <table class="table table-striped table-row-bordered" id="recent_table">
                                <thead>
                                    <tr class="fw-semibold fs-6 text-gray-800">
                                        <th>{{ trans('sw.name')}}</th>
                        ...
                        <div class="tab-pane fade" id="expired_tab">
                            <table class="table table-striped table-row-bordered" id="expired_table">
                                <thead>
                                    <tr class="fw-semibold fs-6 text-gray-800">
                                        <th>{{ trans('sw.name')}}</th>
                        ...
                        <div class="tab-pane fade" id="birthday_tab">
                            <table class="table table-striped table-row-bordered" id="birthday_table">
                                <thead>
                                    <tr class="fw-semibold fs-6 text-gray-800">
                                        <th>{{ trans('sw.name')}}</th>
                        ...
                        <div class="tab-pane fade" id="expiring_tab">
                            <table class="table table-striped table-row-bordered" id="expiring_table">
                                <thead>
                                    <tr class="fw-semibold fs-6 text-gray-800">
                                        <th>{{ trans('sw.name')}}</th>
                                        <th>{{ trans('sw.expire_date')}}</th>
