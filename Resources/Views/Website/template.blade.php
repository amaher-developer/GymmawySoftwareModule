...
<head>
    ...
    <title>Travel - Premium HTML Template Preview - ThemeForest</title>
    <meta name="description" content="&amp;lt;p&amp;gt;
    &amp;lt;strong&amp;gt;
        Travel is modern and stylish site template specifically desi...">
    ...
    <script nonce="puNCsAgeHFHxFAFwWM8FNg==">
        //<![CDATA[
    ...
    <style>
        .preview__envato-logo a{
            ...
            height: 25px;
            width: 200px;
            background: url(https://gymmawy.com/uploads/settings/17931629627997.png) no-repeat;
            background-size: 50%;
        }
    </style>
...
<div class="preview__header" data-view="ctaHeader" data-item-id="799525">
    <div class="preview__envato-logo">
        <a class="header-envato_market" href="{{route('web.template', $client)}}">{{$title}}</a>
    </div>

    <div id="js-preview__actions" class="preview__actions">
        <div class="preview__action--buy">
            <a class="header-buy-now e-btn--3d -color-primary" href="{{route('web.templates')}}">{{trans('sw.back')}}</a>
        </div>
    </div>
</div>

<iframe class="full-screen-preview__frame" src="{{$url}}" name="preview-frame" frameborder="0" noresize="noresize" data-view="fullScreenPreview" allow="geolocation 'self'; autoplay 'self'">
</iframe>
