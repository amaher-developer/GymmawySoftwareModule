        ...
        <div class="content">
            ...
            <div class="payment-details">
                ...
                <div class="detail-row amount-row">
                    <span class="detail-label">{{ $is_arabic ? 'المبلغ المطلوب' : 'Amount Due' }}:  </span>
                    <span class="detail-value">{{ $amount }} {{ $currency }}</span>
                </div>
            </div>

            <div class="paymob-section">
                <div class="paymob-logo">Paymob</div>
                <p class="paymob-text">
                    @if($is_arabic)
                        ادفع بأمان عبر البطاقة البنكية أو المحفظة الإلكترونية
                    @else
            ...
            <p style="text-align: center; color: #666; font-size: 14px;">
                @if($is_arabic)
                    ...
                    <a href="{{ $payment_url }}" style="color: #0073CE; word-break: break-all;">{{ $payment_url }}</a>
                @else
