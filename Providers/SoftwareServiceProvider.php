...
use Modules\Software\Console\AuditMoneyBoxChain;
...
class SoftwareServiceProvider extends ServiceProvider
{
     ...
     */
    protected $moduleName = 'Software';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'software';
    ...
    public function boot()
    {
        ...
        $this->commands([NotifyPTClassesTomorrow::class, AuditMoneyBoxChain::class]);
