...
class GymStoreGroup extends GenericModel
{

    protected $dates = ['deleted_at'];

    protected $table = 'sw_gym_store_groups';
    protected $guarded = ['id'];
    protected $appends = ['name'];

    public static $uploads_path='uploads/store/';
    public static $thumbnails_uploads_path='uploads/store/thumbnails/';
