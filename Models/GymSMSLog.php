...
class GymSMSLog extends GenericModel
{

    protected $dates = ['deleted_at'];

    protected $table = 'sw_gym_sms_logs';
    protected $guarded = ['id'];
    protected $appends = [];
    protected $casts = ['response' => 'json'];
    public static $uploads_path='uploads/sms/';
    public static $thumbnails_uploads_path='uploads/sms/thumbnails/';
